...
import SkeletonFiltersPanel from './SkeletonFiltersPanel';
...
function FiltersPanel() {
    ...
    const { data: genresData, isLoading: isGenresLoading, isError: isGenresError, refetch: refetchGenres } = useFetchGenres()
    ...
    const { data: countriesData, isLoading: isCountriesLoading, isError: isCountriesError, refetch: refetchCountries } = useQuery({
        queryKey: ['countries'],
    ...
    if (isCountriesLoading || isGenresLoading) return <SkeletonFiltersPanel />
    if (isCountriesError || !countriesData || isGenresError || !genresData) return <ErrorFiltersPanel retryAll={retryAll}/>
